...
```
cd existing_repo
git remote add origin https://gitlab.com/ayush.infodales/sony-cloud.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/ayush.infodales/sony-cloud/-/settings/integrations)
